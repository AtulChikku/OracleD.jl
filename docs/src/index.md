...
- **Per-run artefacts & diagnostics.** Every run produces a summary
  (`summary.txt`, `summary.json`, `parameters.txt`, `simulation.log`) and a
  bundled whole-port performance diagnostic suite
